...
@section('content')
<form action="{{ route('posts.update', $post->id) }}" method="POST" class="max-w-sm mx-auto mt-4 md:mt-8 lg:mt-12">
    @csrf
    @method('PUT')
    ...
    <div class="mb-5">
        <label for="foto" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Foto Postingan</label>
