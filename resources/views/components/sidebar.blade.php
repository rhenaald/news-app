            ...
            <ul class="menu">
                ...
                <li class="sidebar-item has-sub">
                    <a href="#" class='sidebar-link'>
                        ...
                        <span>Forms Layout</span>
                    </a>
                    <ul class="submenu">
                        <li class="submenu-item">
                            <a href="form-layout-vertical.html">Vertical Form</a>
                        </li>
                        <li class="submenu-item">
                            <a href="form-layout-horizontal.html">Horizontal Form</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item has-sub">
                ...
                <li class="sidebar-item">
                    <a href="https://github.com/zuramai/mazer" class='sidebar-link'>
