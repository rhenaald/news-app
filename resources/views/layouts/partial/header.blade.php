      ...
      <ul class="space-y-2 font-medium">
        ...
        <div class="flex items-center justify-between p-4 bg-white-100 dark:bg-gray-900">
            <div class="flex items-center space-x-2"> 
               <svg class="w-10 h-10 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
               ...
               <div class="flex flex-col">
                  ...
                  <p class="text-sm text-white dark:text-gray-400">News Talenthub</p>
               </div>
            </div>
            <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="inline-flex items-center p-2 text-white-500 rounded-lg sm:hidden hover:bg-white focus:outline-none focus:ring-2 focus:ring-gray-300 dark:text-white-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
         ...
         <!-- dashboard -->
         <li>
            <a href="/panel" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-white hover:drop-shadow-sm dark:hover:bg-gray-700 group hover:text-gray-900">
         ...
         <!-- profile -->
         <li>
            <a href="/profile" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-white hover:drop-shadow-sm dark:hover:bg-gray-700 group hover:text-gray-900">
         ...
         <li>
            <form method="POST" action="{{ route('logout') }}" x-data>
               <a href="{{ route('logout') }}" @click.prevent="$root.submit();" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-white hover:drop-shadow-sm dark:hover:bg-gray-700 group hover:text-gray-900">
                  <svg class="flex-shrink-0 w-5 h-5 text-white transition duration-75 dark:text-white-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
