        ...
        <div class="grid gap-8 lg:grid-cols-3 md:grid-cols-2">
            ...
            @if($post->author)
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md">
                    <!-- Gambar -->
                    <img src="#" class="w-full h-48 object-cover rounded-t-lg mb-4" alt="Post Image">
                    ...
                    <!-- Link Read More -->
                    <a href="/posts/{{ $post->slug }}" class="inline-flex items-center text-blue-500 font-medium text-primary-600 hover:underline mt-4">
                        Read More &raquo;
